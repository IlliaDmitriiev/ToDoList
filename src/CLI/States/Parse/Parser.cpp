...
bool Parser::parse(IO& io, ParameterStorage& buffer, Parser::Type type) {
    bool result = false;
...
bool Parser::parseID(IO& io, ParameterStorage& buffer){
...
bool Parser::parsePriority(IO& io, ParameterStorage& buffer){
